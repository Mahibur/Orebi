    ...
    return(
        <div className="offer py-5 md:py-0 md:pt-[174px] md:pb-32">
            <Container className="grid grid-rows-4 md:grid-rows-2 grid-cols-1 md:grid-cols-2 gap-3 md:gap-10">
                <img className="row-span-2 w-full object-cover" src={ad_1} alt="ad.png" />
                <img className="w-full object-cover" src={ad_2} alt="ad.png" />
                <img className="w-full object-cover" src={ad_3} alt="ad.png" />
            </Container>
        </div>
    )
}
