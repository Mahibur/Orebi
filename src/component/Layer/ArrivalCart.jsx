...
const ArrivalCart = ({ src, productName, price, color="black",btnText="New" }) => {
  return (
    <div className="arrival-item max-w-[370px]">
      <div className="img h-[394px] relative group">
        <img className="object-cover" src={src} alt="arrival_product.jpg" />
        <div className="overlay absolute bottom-0 left-0 w-full bg-white/50 backdrop-blur-sm py-6 pr-[30px] opacity-0 group-hover:opacity-100 transition-all duration-200">
